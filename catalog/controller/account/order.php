		...
		if ($order_info) {
			...
			foreach ($products as $product) {
				...
				$data['products'][] = [
					...
					'reorder'                  => $reorder,
					'return'                   => ALLOW_RETURN ? $this->url->link('account/returns.add', 'language=' . $this->config->get('config_language') . '&order_id=' . $order_info['order_id'] . '&product_id=' . $product['product_id']) : ''
				];
			}
